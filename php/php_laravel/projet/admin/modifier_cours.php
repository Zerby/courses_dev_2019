...
<section class="white">
    <div class="container">
        ...
        <form class="" method="post" action="<?= $_SERVER['PHP_SELF'] ?>">
            ...
            <div class="row">
                <label for="video_cours" class="browser-default col offset-m1 m3 offset-l1 l3 s10 offset-s1 p-10">Vidéo du cours actuelle</label>
                <input type="text" readonly name="video_cours" title="video_cours" value="<?=$row['video']?>" class="browser-default col s10 offset-s1 m7 l7">
            </div>

            <div class="row">
                <label for="file" class="browser-default col offset-m1 m3 offset-l1 l3 s10 offset-s1 p-10">Nouvelle vidéo du cours</label>
