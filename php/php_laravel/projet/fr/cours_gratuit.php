    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m9 offset-m3 l9 offset-l3">
                ...
                <h2>Initiation : les premiers mots</h2>

                <p>Ce cours vous permettra d'apprendre vos premiers mots en LSF.</p> 
                <p>ce sont les bases de la langue des signes.</p>
                <p>N'hésitez pas à regarder la vidéo plusieurs fois afin de tous les retenir.</p>
        ...
        <div class="row">
            ...
            <div class="video-container">
                <video class="materialboxed" width="100%" controls src="../video/1.mp4" >Vidéo de cours Onsign</video>
            </div>
