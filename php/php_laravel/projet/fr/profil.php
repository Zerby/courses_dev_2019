...
WHERE id = :id";
    ...
    $stmt2->bindValue(':complement_adresse', $_POST['complement_adresse']);
...
<section class="flex-col-center container">
        ...
        <div class="flex-col-center row m-top-30px">
            <h1 class="black-text">Votre profil</h1>
        </div>

			<form action="profil.php?id=<?= $value['id'] ?>" method="post" class="w-75 flex-sa m-bot-30px">
            ...
            <div class="col s12 m6 l6">
             <button type="submit" name="envoyer" class="button button_orange w-100">Enregistrer</button>
            </div>
