...
$title = "Tchat";
$description = " Communiquez avec les autres personnes en formation LSF grâce au chat online de ONSIGN";
$main_color = "grey";
...
$resultat = $pdo->query('SELECT `id_message`, `id_user`, `prenom`, `message`, `date_time` FROM tchat ORDER BY id_message DESC LIMIT 15');
...
<section class="grey flex-col h-65" style="overflow: auto">
    <div class="container white padding z-depth-3">
      ...
      <div class="row message-block" data-id-message="<?= $value['id_message'] ?>" id="tchat">
