		...
		<section class="home_section_lsf h-85 h-inerit flex-col-center">
			<div class="container">
				<div class="row text-white">
					...
					<p>Onsign est une plateforme de cours d'apprentissage à la langue des signes française destinés aux professeurs pour adapter leurs cours aux élèves sourds et malentendants.</p>
					...
					<p>Fort de notre volonté d'aider et convaincus de l'importance de former des professeurs à la langue des signes, nous avons pour objectif de rendre l'éducation accessible à tous.</p>
		...
		<section class="white h-100 h-inerit flex-col-center">
			...
			<div class="row">
				<div class="col s12 m6 l6">
					<p>Pensée pour les professeurs, la plateforme est accesible à tous. Onsign est la première plateforme de cours de langue des signes communautaire.</p>
				...
				<div class="col s12 m6 l6">
					<img src="../images/home_section_communaute.jpg" alt="communauté" class="col s10 offset-s1 m12 l12">
				</div>
			</div>
			</div>
		</section>
...
<!--carousel-->
		...
		<section class="blue h-100 h-inerit flex-col-center">
            ...
            <div class="flex row margin-auto white padding bloc_bordered carousel carousel-slider center" data-indicators="true">
		...
		<section class="row h-100 h-inerit flex-col-center">
			...
			<div class="row">
				...
				<div class="col s12 m6 offset-m1 l7 offset-l1 flex-col-sa padding text-black">
					...
					<p>Onsign vous permet d'accéder à des supports de cours vidéos vous permettant d'apprendre la langue des signes française quelque soit votre niveau actuel.</p>
		...
		<section class="blue h-100 h-inerit flex-col-center">
			<div class="container flex-col-center-sa">
				...
				<div class="col s12 m5 l5 flex-col-center white bloc_bordered padding m-s">
					...
					<img src="../images/offres.png" alt="offre" class="w-85">
				...
				<div class="col s12 m5 offset-m2 l5 offset-l2 flex-col-center white bloc_bordered padding m-s">
					...
					<img src="../images/offres1.png" alt="offre1" class="w-85">
					<a href="#" title="" class="button button_orange w-70 link_inscription">Choisir cette offre</a>
				</div>
				</div>
			</div>
		...
		<section class="home_section_certif h-inerit">
			...
			<div class="container">
				...
				<div class="col s12 m6 l6 text-white flex-col">
					...
					<p>Le certificat Onsign délivré à la fin de votre formation vous permet de certifier votre niveau de maîtrise de la langue des signes français.</p>
                    ...
                    <div class="col s12 m6 l6 push-l1 padding">
                        <img src="../images/certif.png" alt="certification" class="col s10 offset-s1 m12 l12">
                    </div>
                </div>
			</div>
			</div>
                ...
                <div class="carousel carousel-slider center height-500px" data-indicators="true">
                    <div class="carousel-item" href="#one!">
                        <div class="row flex">
                            ...
                            <div class="col s4">
                                <img src="../images/bnp.png" alt="bnp" class="w-90">
                            </div>

                            <div class="col s4">
                                <img src="../images/descartes.png" alt="descartes" class="w-90">
                            </div>

                            <div class="col s4">
                                <img src="../images/education.png" alt="education" class="w-90">
                            </div>
                    ...
                    <div class="carousel-item" href="#two!">
                        ...
                        <div class="col s4">
                            <img src="../images/essec.png" alt="essec" class="w-70">
                        </div>
                    ...
                    <div class="carousel-item" href="#three!">
                        ...
                        <div class="col s4">
                            <img src="../images/lyon.png" alt="lyon" class="w-80">
                        </div>

                        <div class="col s4">
                            <img src="../images/orange.png" alt="orange" class="w-80">
                        </div>

                        <div class="col s4">
                            <img src="../images/surdi.jpeg" alt="surdi" class="w-80">
                        </div>
                    ...
                    <div class="carousel-item" href="#four!">
                        ...
                        <div class="col s4">
                            <img src="../images/louis.png" alt="louis" class="w-90">
                        </div>

                        <div class="col s4">
                            <img src="../images/henry4.png" alt="henry4" class="w-60">
                        </div>

                        <div class="col s4">
                            <img src="../images/fnsf.jpeg" alt="fnsf" class="w-80">
                        </div>
