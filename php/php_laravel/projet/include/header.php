        ...
        <form class="flex-col-sa w-55 h-95" method="post" action="../admin/sign_in.php">
            ...
            <div class="flex-sb w-100">
                <div class="flex-col-sa w-45 h-10">
                    ...
                    <input type="text" name="nom" id="nom" title="nom" required class="w-100">
                </div>
                <div class="flex-col-sa w-45 h-10">
                    <label for="prenom">Prenom</label>
                    <input type="text" name="prenom" id="prenom" title="prenom" required class="w-100">
                </div>
            </div>

            <div class="flex-col-sa h-10 w-100">
                <label for="email">Email</label>
                <input type="email" name="email" id="email" title="email" required class="w-100">
            </div>

            <div class="flex-sb h-10 w-100">
                <div class="flex-col-sa w-45 h-10">
                    <label for="password">Password</label>
                    <input type="password" name="password" id="password" required title="password" class="w-100">
                </div>
                <div class="flex-col-sa w-45 h-10">
                    <label for="tel">Téléphone</label>
                    <input type="tel" name="tel" title="tel" id="tel" required class="w-100">
                </div>
            </div>
            ...
            <div class="flex-col-sa w-100 h-10">
                ...
                <input type="text" name="adresse" id="adresse" title="adresse" required class="w-100">
            </div>

            <div class="flex-col-sa w-100 h-10">
                <label for="complement_adresse">Complement d'adresse</label>
                <input type="text" name="complement_adresse" title="complement_adresse" id="complement_adresse" class="w-100">
            </div>
            ...
            <div class="flex-col-center-sa w-100 m-l-f-10 h-15">
                ...
                <input type="submit" name="submit" value="S'inscrire" class="button button_blue w-100 margin-0">
            </div>
        </form>
    </div>
</div>
    ...
    <nav class="blue">
        <div class="nav-wrapper blue">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li class="link_connexion"><a href="#" title="" class="button_white">connexion</a></li>
            ...
            <ul class="side-nav blue flex-col-sa h-100" id="mobile-demo">
                ...
                <li><a href="apprendre_lsf.php" title="">apprendre la lsf</a></li>
                <li><a href="certification.php" title="">certifications</a></li>
                <li class="link_connexion"><a href="#" title="">connexion</a></li>
