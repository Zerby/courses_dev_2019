...
<footer class="blue">
    <div class="row">
        <div class="col s6 m6 push-m5 l6 push-l5"><a href="index.php"><img src="../images/logo.png" class="logo_footer" alt="logo"></a></div>
        <div class="col s6 m5 l1 offset-l3 padding-2 right-align"><a href="https://www.w3.org" target="_blank"><img src="../images/w3c-logo.png" class="logo_w3c" alt="w3c"></a></div>
    </div>
    <div class="row">
